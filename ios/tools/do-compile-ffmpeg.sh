...
echo "FF_BUILD_ROOT is $FF_BUILD_ROOT"
# ffmpeg build params
...
if [ "$FF_ARCH" = "i386" ]; then
    ...
    FF_BUILD_NAME_FDKAAC=fdkaac-i386
    ...
    FF_BUILD_NAME_FDKAAC=fdkaac-armv7
...
#    FFMPEG_CFG_CPU="--cpu=cortex-a8"
    ...
    FF_BUILD_NAME_FDKAAC=fdkaac-armv7s
...
FFMPEG_DEP_FDKAAC_INC=$FF_BUILD_ROOT/build/$FF_BUILD_NAME_FDKAAC/include
FFMPEG_DEP_FDKAAC_LIB=$FF_BUILD_ROOT/build/$FF_BUILD_NAME_FDKAAC/lib
#--------------------
# with openssl
...
# with fdkaac
echo "fdkaac = ${FFMPEG_DEP_FDKAAC_LIB}"
if [ -f "${FFMPEG_DEP_FDKAAC_LIB}/libfdk-aac.a" ]; then
    echo "fdk aac detected"
    FFMPEG_CFLAGS="$FFMPEG_CFLAGS -I${FFMPEG_DEP_FDKAAC_INC}"
    FFMPEG_DEP_LIBS="$FFMPEG_CFLAGS -L${FFMPEG_DEP_FDKAAC_LIB} -lfdk-aac"
fi
